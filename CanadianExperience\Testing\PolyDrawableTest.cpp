...
namespace Testing
{
    ...
    public:
        ...
        bool CompareColors(Gdiplus::Color colorOne, Gdiplus::Color colorTwo)
        {
            if (colorOne.GetValue() == colorTwo.GetValue()) 
            {
                return true;
            }
            return false;
        ...
        TEST_METHOD(TestCPolyDrawableTestConstruct) 
        {
        ...
        TEST_METHOD(TestCPolyDrawableColor) 
        {
            ...
            Assert::IsTrue(CompareColors(Color::Blue, draw.GetColor()));
